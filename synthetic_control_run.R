...
#This step only works as written if this file is run using the source() command. Otherwise, skip this step and set manually.
	setwd('C:\\Users\\dmw63\\Desktop\\My documents h\\GATES\\CausalImpact code\\Git-synthetic-control-master BoomSpikeSlab\\synthetic-control-master\\')
...
output_directory <- 'C:\\Users\\dmw63\\Desktop\\My documents h\\GATES\\CausalImpact code\\Git-synthetic-control-master BoomSpikeSlab\\synthetic-control-master\\Results'   #Directory where results will be saved.
