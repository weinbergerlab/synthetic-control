...
kable(sensitivity_analysis_pred_2_intervals,  align = 'c', caption = 'Number of Predictors per Iteration = 2')
```

```{r pred_sensitivity_10}
kable(sensitivity_analysis_pred_10_intervals,  align = 'c', caption = 'Number of Predictors per Iteration = 10')
```
